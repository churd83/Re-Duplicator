...
#define STRING_CONFIG_H_AUTHOR "(ReDuplicator)" // Who made the changes.
...
//#define MACHINE_UUID "9ab2a137-fe63-4692-b3c0-f914ee4bb962"
...
#define TEMP_RESIDENCY_TIME     20
  // (seconds) Time to wait for hotend to "settle" in M109
 ...
 *
 * A498 is assumed for unspecified drivers.
 *
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 818 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 400, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, -33, 0 }
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 140.42
  #define XY_DIAG_BD 141.55
...
#define PREHEAT_1_TEMP_HOTEND 270
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS 165  // Initial brightness (0-255)
